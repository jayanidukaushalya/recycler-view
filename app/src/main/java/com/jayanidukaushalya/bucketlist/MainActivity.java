    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPlacesToGo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this, PlacesToGoActivity.class));
            }
        });

        btnThingsToDo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this, ThingsToDoActivity.class));
            }
        });
    }
}